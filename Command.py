...
def command_process():
    ...
    user_reply = stt.main('command_rec.wav')  #REAL
    print(user_reply)
...
def action_call(action):
    ...
    if action == possibleActions[0]:
        ...
        tts.api_call(spoken, bemo_path + 'command_send_tweet.wav')
        arec.audio_play2(bemo_path + 'command_send_tweet.wav')
        
        #Call Audio Recording Program
        arec.audio_rec(bemo_path + 'command_rec_send_tweet.wav')
        ...
        print(spoken)
        # Call text-to-speech(spoken) service
        tts.api_call(spoken, bemo_path + 'command_read_tweet.wav')
        arec.audio_play2(bemo_path + 'command_read_tweet.wav')
        ...
        print(spoken)
        tts.api_call(spoken,bemo_path +  'command_read_news.wav')
        arec.audio_play2(bemo_path + 'command_read_news.wav')
        ...
        #DOWNLOADING CORRECT PORDCASTS & PLAYING IT
